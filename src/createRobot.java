...
public class createRobot {
	...
	public static void compile () {
		String fileToCompile = "robots/custom/AGRobot.java"; // which file to compile * rhyming :) *
	...
	public static void createRobotFile(double[] chromo){
		try {
			FileWriter fstream = new FileWriter("robots/custom/AGRobot.java"); // file name to create
